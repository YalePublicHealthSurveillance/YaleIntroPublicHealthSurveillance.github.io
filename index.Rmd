...
### 2. Recorded Presentation: What is 'vaccine impact'?

-In this brief video, we will discuss ways to evaluate the effects of vaccines and the distinctions between different metrics

### 3. Recorded Presentation: Administrative data: challenges and opportunities for evaluation studies

-In this brief video, we will discuss types of administrative data and sources for these types of data, along with limitations of this type of data

### 4. Live session 1: Data Wrangling
...
### 5. Recorded presentation: Interrupted time series analysis
...
### 6. Live session 2: Trend analysis and interrupted time series analysis

### 7. Live session 3: Case study: PCV impact in The Gambia
...
### 8. Recorded presentation: Using controls and synthetic controls
...
### 9. Live Session 4: Synthetic controls analysis (Case study: South Africa); presenting results and dealing with uncertainty
